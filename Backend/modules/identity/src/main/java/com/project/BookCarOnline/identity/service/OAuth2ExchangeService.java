...
import com.project.BookCarOnline.identity.dto.response.ExchangeTokenResponse;
    ...
    private Account saveCustomer(String email, String name, String picture,String provider, String providerId) {
        ...
        var account = accountRepository.save(
                Account.builder()
                        ...
                        .provider(com.project.BookCarOnline.identity.entity.enums.Provider.valueOf(provider.toUpperCase()))
