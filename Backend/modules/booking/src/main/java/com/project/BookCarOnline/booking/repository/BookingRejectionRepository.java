...
public interface BookingRejectionRepository extends JpaRepository<BookingRejection, String> {
    ...
    @Query("SELECT r.driverId FROM BookingRejection r WHERE r.booking.bookingId = :bookingId")
...
//     Đếm số lần REJECTED của một tài xế (dùng cho scoring).
    ...
    boolean existsByBooking_BookingIdAndDriverId(String bookingId, String driverId);
}
