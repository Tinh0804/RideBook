...
public class BookingController {
    ...
    public APIResponse<List<BookingDetailResponse>> getAllBookings() {
        ...
        List<BookingDetailResponse> bookings = bookingQueryService.getAllBookings();
    ...
    public APIResponse<BookingDetailResponse> getBookingById(@PathVariable String bookingId) {
        ...
        BookingDetailResponse booking = bookingQueryService.getBookingById(bookingId);
    ...
    public APIResponse<List<AvailableRideResponse>> getAvailableRides(
        ...
        List<AvailableRideResponse> rides = bookingQueryService.getAvailableRides(driverArea);
    ...
    public APIResponse<List<BookingDetailResponse>> getBookingsByCustomer(@PathVariable String customerId) {
        ...
        List<BookingDetailResponse> bookings = bookingQueryService.getBookingsByCustomer(customerId);
        return APIResponse.<List<BookingDetailResponse>>builder()
                .status(HttpStatus.OK.value())
    ...
    public APIResponse<BookingDetailResponse> getActiveBookingByCustomer(@PathVariable String customerId) {
        ...
        BookingDetailResponse booking = bookingQueryService.getActiveBookingByCustomer(customerId);
        return APIResponse.<BookingDetailResponse>builder()
                .status(HttpStatus.OK.value())
    ...
    public APIResponse<List<BookingDetailResponse>> getBookingsByDriver(@PathVariable String driverId) {
        ...
        List<BookingDetailResponse> bookings = bookingQueryService.getBookingsByDriver(driverId);
        return APIResponse.<List<BookingDetailResponse>>builder()
                .status(HttpStatus.OK.value())
    ...
    public APIResponse<BookingDetailResponse> getActiveBookingByDriver(@PathVariable String driverId) {
        ...
        BookingDetailResponse booking = bookingQueryService.getActiveBookingByDriver(driverId);
        return APIResponse.<BookingDetailResponse>builder()
                .status(HttpStatus.OK.value())
    ...
    public APIResponse<Page<BookingDetailResponse>> getBookingsByDriverPaginated(
        ...
        Page<BookingDetailResponse> bookings = bookingQueryService.getBookingsByDriverPaginated(
    ...
    public APIResponse<List<EstimatePriceResponse>> estimatePrice(@Valid @RequestBody EstimatePriceRequest request) {
        ...
        return APIResponse.<List<com.project.BookCarOnline.booking.dto.response.EstimatePriceResponse>>builder()
                .status(HttpStatus.OK.value())
    ...
    public APIResponse<List<BookingDetailResponse>> adminGetAll() {
        ...
        return APIResponse.<List<BookingDetailResponse>>builder()
                ...
                .result(bookingQueryService.getAllBookings())
                .build();
    }
