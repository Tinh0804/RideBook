...
import com.project.BookCarOnline.finance.service.payment.MoMoService;
...
public class PaymentController {
    ...
    public APIResponse<PaymentCallbackResponse> vnpayReturn(
        ...
        boolean validCallback = response.getOrderId() != null;
        if (validCallback && vnpTxnRef.startsWith("TOPUP_")) {
    ...
    public APIResponse<PaymentCallbackResponse> momoReturn(
            @RequestParam Map<String, String> params,
            jakarta.servlet.http.HttpServletResponse httpResponse) throws java.io.IOException {
        ...
        boolean validCallback = response.getOrderId() != null;
        if (validCallback && orderId.startsWith("TOPUP_")) {
