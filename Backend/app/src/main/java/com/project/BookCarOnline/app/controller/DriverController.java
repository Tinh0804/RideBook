...
import com.project.BookCarOnline.booking.dto.request.DriverLocationRequest;
...
public class DriverController {
    ...
    public APIResponse<DriverDashboardResponse> getMyDashboard() {
        ...
        return APIResponse.<com.project.BookCarOnline.app.dto.reporting.DriverDashboardResponse>builder()
                .status(HttpStatus.OK.value())
    ...
    public APIResponse<com.project.BookCarOnline.app.dto.reporting.DriverRevenueResponse> getMyRevenue(
            @RequestParam(name = "period", defaultValue = "week") String period) {
        com.project.BookCarOnline.app.dto.reporting.DriverRevenueResponse response = driverService.getDriverRevenue(period);
        return APIResponse.<com.project.BookCarOnline.app.dto.reporting.DriverRevenueResponse>builder()
                .status(HttpStatus.OK.value())
    ...
    public APIResponse<DailyRevenueDTO> getDailyRevenue(
        ...
        com.project.BookCarOnline.app.dto.reporting.DailyRevenueDTO response = driverService.getDailyRevenue(dateStr);
        return APIResponse.<com.project.BookCarOnline.app.dto.reporting.DailyRevenueDTO>builder()
                .status(HttpStatus.OK.value())
