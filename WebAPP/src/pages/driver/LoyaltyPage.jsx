...
const LoyaltyPage = () => {
  ...
  return (
    <div className="h-full overflow-y-auto bg-[#e8ece3] dark:bg-surface-dark pointer-events-auto pb-12">
      <div className="mx-auto w-full max-w-3xl space-y-6 p-5 lg:p-8">
        <div>
          <h1 className="font-display text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Hạng thành viên & Quyền lợi</h1>
